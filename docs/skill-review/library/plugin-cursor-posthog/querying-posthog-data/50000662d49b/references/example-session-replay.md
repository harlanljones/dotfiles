...
SELECT
    ...
    date_diff('DAY', toDateTime('2026-06-08 12:31:58.728197'), expiry_time) AS recording_ttl,
    greaterOrEquals(max(s._timestamp), toDateTime('2026-06-08 12:26:58.727431')) AS ongoing,
...
WHERE
    and(greaterOrEquals(s.min_first_timestamp, toDateTime('2026-06-05 00:00:00.000000')), lessOrEquals(s.min_first_timestamp, toDateTime('2026-06-08 12:31:58.727596')))
GROUP BY
    session_id
HAVING
    and(greaterOrEquals(expiry_time, toDateTime('2026-06-08 12:31:58.728085')), equals(max(s.is_deleted), 0), greater(active_seconds, 5.0))
ORDER BY
    start_time DESC,
    session_id DESC
LIMIT 50000

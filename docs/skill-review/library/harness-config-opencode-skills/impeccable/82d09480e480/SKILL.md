...
<!-- Review HJ-738: Q-impeccable-license asks who confirms the Apache-2.0 declaration and upstream maintenance; Q-impeccable-pack asks whether this stays provider-managed or joins an optional pack. -->